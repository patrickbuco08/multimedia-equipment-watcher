    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2">Register as Staff Member</p>
            </div>
            ...
            <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-xs text-blue-800"><span class="font-semibold">Note:</span> All new registrations are created as Staff accounts with access to equipment and borrowing management.</p>
            </div>
        </div>
    </div>
</body>
